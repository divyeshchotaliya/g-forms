...
@section('content')
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
        @foreach ($forms as $form)
            <div class="bg-white border p-6 space-x-6 flex justify-between items-start">
        ...
        @endforeach
        <button class="bg-white border p-6" x-on:click="$store.app.toggleModal('createFormModal')">
            Create form
        </button>
    </div>
@endsection
...
@section('modal')
    <div x-show="$store.app.createFormModal"
        class="fixed top-0 left-0 bg-gray-700 bg-opacity-30 w-full h-full z-[1111] overflow-y-auto p-4" x-data="createForm">
        <div class="max-w-2xl mx-auto bg-white my-10 p-6 space-y-6">
            ...
            <template x-for="(item, index) in fields">
                <div class="p-6 border bg-gray-50 space-y-6">
                    <div class="grid grid-cols-3 gap-6">
                        ...
                        <template
                            ...
                            <div class="tw-form-group col-span-3">
                                ...
                                <div class="grid grid-cols-3 gap-6">
                                    ...
                                    <button class="tw-btn bg-white border" x-on:click="item.options.value.push('')">+
                                        Add</button>
                                </div>
                        ...
                        <div class="tw-form-group">
                            ...
                            <div class="flex space-x-2">
                                ...
                                <div class="flex items-center space-x-1">
                                    <input type="radio" x-bind:name="`required_${index}`" x-bind:id="`required_no_${index}`"
                                        x-model="item.isRequired" x-bind:value="0" />
